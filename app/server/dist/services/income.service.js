...
var IncomeService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, typeorm_1.getRepository(entities_1.Income)
    ...
    IncomeService.createIncome = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, source = _a.source, amount = _a.amount;
                        userId = req.params.userId;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                    ...
                    case 2:
                        user = _b.sent();
                        return [4 /*yield*/, entities_1.Income.create({
                                amount: amount,
                                source: source,
                                user: user,
                            }).save()];
    ...
    IncomeService.getLastIncomeOfUser = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, lastIncome, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = req.params.userId;
